...
void CheckClientWeapon(DataPack dp)
{
    ...
    if (g_eWeaponSkin[data].iSlot == SLOT_3)
    {
        ...
        weapon = GetPlayerWeaponEntity(client, g_eWeaponSkin[data].szWeapon);
...
public Action Timer_RevertAmmo(Handle timer, DataPack pack)
{
    ...
    if (PAmmo > -1)
        SetEntProp(weapon, Prop_Data, "m_iPrimaryAmmoCount", PAmmo);
    if (SAmmo > -1)
        SetEntProp(weapon, Prop_Data, "m_iSecondaryAmmoCount", SAmmo);
    if (Clip1 > -1)
        SetEntProp(weapon, Prop_Data, "m_iClip1", Clip1);
    if (Clip2 > -1)
...
{
    if (
        strcmp(classname, "weapon_knife") == 0 || strcmp(classname, "weapon_knife_t") == 0 || strcmp(classname, "weapon_bayonet") == 0 || strcmp(classname, "weapon_knife_gut") == 0 || strcmp(classname, "weapon_knife_flip") == 0 || strcmp(classname, "weapon_knife_m9_bayonet") == 0 || strcmp(classname, "weapon_knife_karambit") == 0 || strcmp(classname, "weapon_knife_tactical") == 0 || strcmp(classname, "weapon_knife_butterfly") == 0 || strcmp(classname, "weapon_knife_falchion") == 0 || strcmp(classname, "weapon_knife_push") == 0 || strcmp(classname, "weapon_knife_survival_bowie") == 0 || strcmp(classname, "weapon_knife_ursus") == 0 || strcmp(classname, "weapon_knife_windowmaker") == 0 || strcmp(classname, "weapon_knife_stiletto") == 0 || strcmp(classname, "weapon_knife_jackknife") == 0)
        return true;
